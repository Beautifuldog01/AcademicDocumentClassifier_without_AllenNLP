...
class BalancedBatchSampler(Sampler):
    ...
    def __iter__(self):
        ...
        for i in range(total_batches):
            positive_indices = random.choices(self.all_positive_indices, k=num_positive_per_batch)          
            negative_indices = random.choices(self.all_negative_indices, k=num_negative_per_batch)
...
class ProportionalSampler(Sampler):
    ...
    def __iter__(self):
        ...
        for i in range(total_batches):
            ...
            num_negative_per_batch = min(num_negative_per_batch, len(self.all_negative_indices))
